    ...
    >
      <div className="container" style={{ maxWidth: "820px" }}>
        ...
        <div className="text-center mb-4 mb-md-5">
          ...
          >
            <i className="bi bi-magic text-white" style={{ fontSize: "1.5rem" }}></i>
          </div>
          ...
          <p className="text-muted mb-0 mx-auto" style={{ maxWidth: "480px" }}>
            Paste any piece of writing and let AI refine the tone,
            grammar, and clarity instantly.
          </p>
        </div>
          ...
          <div className="card border-0 shadow-sm rounded-4">
            <div className="card-body p-4 p-md-5">
              ...
              <div className="d-flex align-items-center gap-2 mb-3">
                ...
                <h5 className="fw-bold mb-0">Improved Text</h5>
              </div>
